...
# else:
OUTPUT_JSONL = Path(f"train_qwen_soc_{REGION}_varyingefficiency_tab6.jsonl")
# OUTPUT_JSONL = Path(f"test_qwen_soc_{REGION}_efficiency{int(eta_c*100)}_tab6.jsonl")
