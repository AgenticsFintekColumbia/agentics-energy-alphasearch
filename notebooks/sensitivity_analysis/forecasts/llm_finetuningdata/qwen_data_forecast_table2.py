...
# ---------- CONFIG ----------
# version = np.random.choice(["actual", "forecast"])
version = "forecast"
data_version = version
if data_version == "actual":
    forecast_type = "perfect"
else:
    # forecast_type =np.random.choice(["RF", "LSTM", "TLLM"])
    forecast_type = "RF"
duration_hours=4
soc_init=0.5
soc_min=0.0
...
# OUTPUT_JSONL = Path(f"train_qwen_soc_{REGION}_{version}_{forecast_type}_act.jsonl")
OUTPUT_JSONL = Path(f"test_qwen_soc_{REGION}_{version}_{forecast_type}_tab2_1.jsonl")
