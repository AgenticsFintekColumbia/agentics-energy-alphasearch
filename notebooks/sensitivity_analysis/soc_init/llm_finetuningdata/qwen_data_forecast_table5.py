...
# else:
# OUTPUT_JSONL = Path(f"train_qwen_soc_{REGION}_varyingsocinit_tab5.jsonl")
OUTPUT_JSONL = Path(f"test_qwen_soc_{REGION}_socinit{int(soc_init*100)}_tab5.jsonl")
...
async def main():
    ...
    batterydetails.capacity_MWh = 49.44
    batterydetails.cmax_MW = 12.36
    batterydetails.dmax_MW = 12.36
